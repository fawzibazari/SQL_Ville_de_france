...
#6 
SELECT ville_nom, ville_surface from villes_france_free WHERE LEFT(ville_departement,2)!=97 ORDER BY ville_surface DESC LIMIT 10
#7
...
#9
SELECT
	ROUND(AVG(ville_surface)) as average,
	ville_nom
FROM
	villes_france_free
	GROUP BY ville_nom
